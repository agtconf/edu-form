angular.module('e2e-mocks', ['ngMockE2E','ngCookies'])
.run(function($httpBackend,$cookies,$http,$log,$filter,filterFilter) {
    // Do your mock
	...
	// GET all municipios from municipios array 
    $httpBackend.whenGET(/api\/v1\/municipios/).respond(function(method, url,data,headers) {
        console.log("llamada a GET api/v1/municipios "+method + " params:"+ url.split('?')[1]+ " url:"+url);
        
        return [200, municipios, {}];
    });
